...
public class DEPInveXclMgmt extends fwk.base.DataUnit {
    ...
    /**
	 * <pre>중고단말기재고정산상세등록엑셀업로드</pre>
	 *
	 * @author 양재석 (jsyang)
	 * @since 2015-12-18 10:01:46
	 *
	 * @param requestData 요청정보 DataSet 객체
	 * @param onlineCtx   요청 컨텍스트 정보
	 * @return 처리결과 DataSet 객체
	 */
	public IDataSet dIEpEqpInveXclDtlRgstExcelUp(IDataSet requestData, IOnlineContext onlineCtx) {
        IDataSet responseData = new DataSet();
    
        // 1.쿼리문 호출
        dbInsert("IEpEqpInveXclDtlRgstExcelUp", requestData, onlineCtx);
    
        return responseData;
    }

    /**
	 * <pre>중고단말기재고정산임시엑셀업로드수정</pre>
	 *
	 * @author 양재석 (jsyang)
	 * @since 2015-10-14 10:15:02
	 *
	 ...
	 * @return 처리결과 DataSet 객체
	 */
	public IDataSet dUEpEqpInveXclTempExcelUpd(IDataSet requestData, IOnlineContext onlineCtx) {
        IDataSet responseData = new DataSet();
    
        // 1.쿼리문 호출
        dbInsert("UEpEqpInveXclTempExcelUpd", requestData, onlineCtx);
    
        return responseData;
    }

    /**
	 * <pre>중고단말기재고정산상세임시정보삭제</pre>
	 *
	 * @author 양재석 (jsyang)
	 * @since 2015-12-18 13:02:35
	 *
	 * @param requestData 요청정보 DataSet 객체
	 * @param onlineCtx   요청 컨텍스트 정보
	 * @return 처리결과 DataSet 객체
	 */
	public IDataSet dDEpEqpInveXclDtlTempInfoDel(IDataSet requestData, IOnlineContext onlineCtx) {
        IDataSet responseData = new DataSet();
    
        // 1.쿼리문 호출
        dbInsert("DEpEqpInveXclDtlTempInfoDel", requestData, onlineCtx);
    
        return responseData;
    }

    /**
	 * <pre>중고단말기확정재고취소여부</pre>
	 *
	 * @author 양재석 (jsyang)
	 * @since 2016-01-27 09:13:43
	 *
	 * @param requestData 요청정보 DataSet 객체
	 * @param onlineCtx   요청 컨텍스트 정보
	 * @return 처리결과 DataSet 객체
	 */
	public IDataSet dSInqEpEqpArrivInveCnclYn(IDataSet requestData, IOnlineContext onlineCtx) {
        IDataSet responseData = new DataSet();
    
        // 1.쿼리문 호출
        IRecordSet rsReturn = dbSelect("SInqEpEqpArrivInveCnclYn", requestData, onlineCtx);
        // 2.결과값 셋팅
        responseData.putRecordSet("RS_ARRIV_INVE_CNCL_YN", rsReturn);
    
        return responseData;
    }

    /**
	 * <pre>중고단말기입금관리재고정산등록</pre>
	 *
	 * @author 양재석 (jsyang)
	 * @since 2016-02-04 14:43:17
	 *
	 * @param requestData 요청정보 DataSet 객체
	 * @param onlineCtx   요청 컨텍스트 정보
	 * @return 처리결과 DataSet 객체
	 */
	public IDataSet dIEpEqpDpstMgmtInveXclRgst(IDataSet requestData, IOnlineContext onlineCtx) {
        IDataSet responseData = new DataSet();
    
        // 1.쿼리문 호출
        dbInsert("IEpEqpDpstMgmtInveXclRgst", requestData, onlineCtx);
