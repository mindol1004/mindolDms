    ...
    public IDataSet fRegDisSaleIn(IDataSet requestData, IOnlineContext onlineCtx) {
        ...
        try {
            ...
            if (delRs != null) {
                ...
                Long prodInMgmtNo = Long.parseLong(seqDs.getField("PROD_IN_MGMT_NO"));
                ...
                for (int i = 0; i < delRs.getRecordCount(); i++) {
                    ...
                    delRc.set("PROD_IN_MGMT_NO", "IN" + (prodInMgmtNo + i));
                    //delRc.set("IN_OUT_SEQ", hstSeq);
                    //delRc.set("PROD_IN_SEQ", inSeq);
    ...
    public IDataSet fRegDisSaleOut(IDataSet requestData, IOnlineContext onlineCtx) {
        ...
        try {
            ...
            if (saleRs != null) {
                ...
                Long prodOutMgmtNo = Long.parseLong(seqDs.getField("PROD_OUT_MGMT_NO"));
                ...
                for (int i = 0; i < saleRs.getRecordCount(); i++) {
                    ...
                    saleRc.set("PROD_OUT_MGMT_NO", "OT" + (prodOutMgmtNo + i));
                    ...
                    saleRc.set("OUT_CL", masterDs.getField("OUT_CL") == null ? "205" : masterDs.getField("OUT_CL")); // 판매출고
                    saleRc.set("IN_OUT_CL", masterDs.getField("IN_OUT_CL") == null ? "200" : masterDs.getField("IN_OUT_CL")); // 출고
                    saleRc.set("IN_OUT_DTL_CL", masterDs.getField("IN_OUT_DTL_CL") == null ? "205" : masterDs.getField("IN_OUT_DTL_CL")); // 판매출고
