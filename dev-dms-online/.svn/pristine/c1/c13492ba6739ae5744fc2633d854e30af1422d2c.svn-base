...
public class PNRPrchCnclXclMgmt extends fwk.base.ProcessUnit {
	 ...
	 *		- field : PRCH_CASH_SLIP_NO [매입현금전표번호]
	 *		- field : PRCH_CASH_SLIP_ST_CD [매입현금전표상태]
	 *		- field : CASH_TAXBILL_NO [현금셰금계산서번호]
	 *		- field : CASH_TAX_BILL_ST_CD [현금셰금계산서상태코드]
	 *		- field : PRCH_NO [매입번호]
	 *		- field : CNCL_SLIP_NO [매입취소전표번호]
	 *		- field : CNCL_SLIP_ST_CD [매입취소전표상태]
	 *		- field : CNCL_CASH_SLIP_NO [매입취소현금전표번호]
	 *		- field : CNCL_CASH_SLIP_ST_CD [매입취소현금전표상태]
