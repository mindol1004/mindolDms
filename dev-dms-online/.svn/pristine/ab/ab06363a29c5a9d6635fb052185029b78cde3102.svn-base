...
public class DEPEpEqpDisMgmt extends fwk.base.DataUnit {
	 ...
	 * @return 처리결과 DataSet 객체
	 */
	public IDataSet dSEpEqpProdDisUnitPrcRgstCnt(IDataSet requestData, IOnlineContext onlineCtx) {
        IDataSet responseData = new DataSet();
    
        // 1.쿼리문 호출     
        IRecord record = dbSelectSingle("SEpEqpProdDisUnitPrcRgstCnt", requestData, onlineCtx);
    ...
    /**
	 * <pre>중고단말기상품재고입출고이력등록건수조회</pre>
	 *
	 * @author 양재석 (jsyang)
	 * @since 2016-01-07 13:20:26
	 *
	 * @param requestData 요청정보 DataSet 객체
	 * @param onlineCtx   요청 컨텍스트 정보
	 * @return 처리결과 DataSet 객체
	 */
	public IDataSet dSEpEqpProdDisInoutHstRgstCnt(IDataSet requestData, IOnlineContext onlineCtx) {
        IDataSet responseData = new DataSet();
    
        // 1.쿼리문 호출     
        IRecord record = dbSelectSingle("SEpEqpProdDisInoutHstRgstCnt", requestData, onlineCtx);
	 ...
	 *
	 * @author 양재석 (jsyang)
	 * @since 2016-01-07 14:32:01
	 *
	 * @param requestData 요청정보 DataSet 객체
	 * @param onlineCtx   요청 컨텍스트 정보
	 * @return 처리결과 DataSet 객체
	 */
	public IDataSet dSInqEpEqpProdDisRgstCnt(IDataSet requestData, IOnlineContext onlineCtx) {
        IDataSet responseData = new DataSet();
    
        // 1.쿼리문 호출     
        IRecord record = dbSelectSingle("SInqEpEqpProdDisRgstCnt", requestData, onlineCtx);
