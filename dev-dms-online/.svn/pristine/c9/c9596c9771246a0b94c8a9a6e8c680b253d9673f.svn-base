...
public class FNRCntrtPrstMgmt extends fwk.base.FunctionUnit {
	 ...
	 *
	 * @author 이영진 (newnofixing)
	 * @since 2015-10-29 10:14:03
	 *
	 * @param requestData 요청정보 DataSet 객체
	 * @param onlineCtx   요청 컨텍스트 정보
	 * @return 처리결과 DataSet 객체
	 */
	public IDataSet fDelCntrtPrstUscanDtl(IDataSet requestData, IOnlineContext onlineCtx) {
	    IDataSet responseData = new DataSet();
        ...
        try {
            ...
            responseData = dNRCntrtPrstMgmt.dDCntrtPrstUscanDtl(requestData, onlineCtx);
	 ...
	 * @return 처리결과 DataSet 객체
	 */
    public IDataSet fRegCntrtPrstUscanDtl(IDataSet requestData, IOnlineContext onlineCtx) {
        IDataSet responseData = new DataSet();
        ...
        try {           
            ...
            // 2. Validation DM호출
            responseData = dNRCntrtPrstMgmt.dICntrtPrstUscanDtl(requestData, onlineCtx);
        } catch ( BizRuntimeException e ) {
            throw e;
        }
