...
public class DNRCnslMgmt extends fwk.base.DataUnit {
	 ...
	 * @return 처리결과 DataSet 객체
	 */
    public IDataSet dIEqpInsuCnsl(IDataSet requestData, IOnlineContext onlineCtx) {
        IDataSet responseData = new DataSet();
        // 1.쿼리문 호출
        dbInsert("IEqpInsuCnsl", requestData, onlineCtx);
        return responseData;
    }
	 ...
	 * @return 처리결과 DataSet 객체
	 */
    public IDataSet dIEqpInsuCnslNEW(IDataSet requestData, IOnlineContext onlineCtx) {
        IDataSet responseData = new DataSet();
        // 1.쿼리문 호출
        dbInsert("IEqpInsuCnslNEW", requestData, onlineCtx);
        return responseData;
    }
	 ...
	 * @return 처리결과 DataSet 객체
	 */
    public IDataSet dSEqpInsuCnslNo(IDataSet requestData, IOnlineContext onlineCtx) {
        IDataSet responseData = new DataSet();
        // 1.쿼리문 호출     
        IRecord record = dbSelectSingle("SEqpInsuCnslNo", requestData, onlineCtx);
        // 2.결과값 셋팅     
        responseData.putFieldMap(record);
        return responseData;
    }
	 ...
	 * @return 처리결과 DataSet 객체
	 */
    public IDataSet dSEqpInsuCnslPaging(IDataSet requestData, IOnlineContext onlineCtx) {
        IDataSet responseData = new DataSet();
        // 1.쿼리문 호출
        IRecordSet rsReturn = dbSelect("SEqpInsuCnslPaging", requestData, onlineCtx);
        // 2.결과값 셋팅
        responseData.putRecordSet("RS_MAIN", rsReturn);
        return responseData;
    }
	 ...
	 * @return 처리결과 DataSet 객체
	 */
    public IDataSet dSEqpInsuCnslTotCnt(IDataSet requestData, IOnlineContext onlineCtx) {
        IDataSet responseData = new DataSet();
        // 1.쿼리문 호출
        IRecord record = dbSelectSingle("SEqpInsuCnslTotCnt", requestData, onlineCtx);
        // 2.결과값 셋팅
        responseData.putFieldMap(record);
        return responseData;
    }
	 ...
	 * @return 처리결과 DataSet 객체
	 */
    public IDataSet dUEqpInsuCnsl(IDataSet requestData, IOnlineContext onlineCtx) {
        IDataSet responseData = new DataSet();
        // 1.쿼리문 호출
        dbInsert("UEqpInsuCnsl", requestData, onlineCtx);
        return responseData;
    }
