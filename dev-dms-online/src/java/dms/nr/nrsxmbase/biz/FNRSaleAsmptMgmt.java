...
public class FNRSaleAsmptMgmt extends fwk.base.FunctionUnit {
	...
	public IDataSet fSaveSaleAsmptSlip(IDataSet requestData, IOnlineContext onlineCtx) {
        ...
        try {
            ...
            requestData.putField("SLIP_TYPE", "SALE_ASMPT");
	 ...
	 *
	 * @author 문재웅 (jaiwoong)
	 * @since 2015-09-24 15:31:23
	 *
	 * @param requestData 요청정보 DataSet 객체
	 * @param onlineCtx   요청 컨텍스트 정보
	 * @return 처리결과 DataSet 객체
	 */
	public IDataSet fInqSaleAsmptAllExcel(IDataSet requestData, IOnlineContext onlineCtx) {
        IDataSet responseData = new DataSet();
        ...
        try {
           ...
           // 1. DU lookup
            ...
            // 2. LISTDM호출
            responseData = dNRSaleAsmptMgmt.dSsaleAsmptAllExcel(requestData, onlineCtx); 
	 ...
	 * @return 처리결과 DataSet 객체
	 */
	public IDataSet fSaveSaleAsmptSlipDel(IDataSet requestData, IOnlineContext onlineCtx) {
	    Log log = getLog(onlineCtx);
	    IDataSet responseData = new DataSet();
	    CommonArea ca = getCommonArea(onlineCtx);
	    ...
	    try{
	    	//for(int i=0; i<rs.getRecordCount(); i++){
				...
				params.put("POST_SLIP_DATASET", dsXml);
				log.info("(((((((((((((((((((((((((((((((fSaveSaleAsmptSlipDel() params :"+ params);
				String jobExecutionId = callBatchJob("EPR011", params, onlineCtx);
			    waitBatchJobEnd(jobExecutionId, 10000);
			    int result = getJobReturnCode(jobExecutionId);
			    
			    
				log.info("(((((((((((((((((((((((((((((((fSaveSaleAsmptSlipDel() result :"+ result);
	 ...
	 *
	 * @author 김혁범 (kezmain1)
	 * @since 2015-11-04 16:29:47
	 *
	 * @param requestData 요청정보 DataSet 객체
	 * @param onlineCtx   요청 컨텍스트 정보
	 * @return 처리결과 DataSet 객체
	 */
	public IDataSet fInqSaleSecondReBatch(IDataSet requestData, IOnlineContext onlineCtx) {
		IDataSet responseData = new DataSet();
	    Log log = getLog(onlineCtx);
	    CommonArea ca = getCommonArea(onlineCtx);
	
	    try {	    		    	
	    		log.debug("(((((((((((((((((((((((((((((((fInqSaleSecondReBatch() fInqSaleSecondReBatch requestData:"+ requestData);
			    ...
			    params.put("COMPONENTNAME_LOCAL_ONLY", "dms.nr.XCR004");				
				params.put("ONDEMAND_DATASET", dsXml);
				params.put("SALE_ASMPT_YM_TS",2);
				
				log.debug("(((((((((((((((((((((((((((((((fInqSaleSecondReBatch() params :"+ params);
				...
				log.debug("(((((((((((((((((((((((((((((((fInqSaleSecondReBatch() result :"+ result);
