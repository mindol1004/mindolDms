...
public class PBIEqpBarcdMgmt extends fwk.base.ProcessUnit {
	 ...
	 * </pre>
	 */
	public IDataSet pInqEqpseq(IDataSet requestData, IOnlineContext onlineCtx) {
	    IDataSet responseData = new DataSet();
        try {
            // 1. FU lookup
            FBIBoxBarcdMgmt fBIBoxBarcdMgmt = (FBIBoxBarcdMgmt) lookupFunctionUnit(FBIBoxBarcdMgmt.class);
            // 2. FM 호출
            responseData = fBIBoxBarcdMgmt.fInqEqpseq(requestData, onlineCtx);
            // 3. 결과값 리턴
