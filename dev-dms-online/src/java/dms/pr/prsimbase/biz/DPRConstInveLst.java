 ...
 * @author 이준우 (elmsliw)
 */
public class DPRConstInveLst extends fwk.base.DataUnit {
	 ...
	 * Default Constructor
	 */
	public DPRConstInveLst(){
		super();
	}

	/**
	 * <pre>[FM]구성품재고조회목록</pre>
	 *
	 * @author 이준우 (elmsliw)
	 * @since 2015-09-14 16:36:52
	 *
	 * @param requestData 요청정보 DataSet 객체
	 * @param onlineCtx   요청 컨텍스트 정보
	 * @return 처리결과 DataSet 객체
	 */
    public IDataSet dSConstInveLstPaging(IDataSet requestData, IOnlineContext onlineCtx) {
	 ...
	 * @return 처리결과 DataSet 객체
	 */
    public IDataSet dSConstInveLstTotCnt(IDataSet requestData, IOnlineContext onlineCtx) {
        IDataSet responseData = new DataSet();
