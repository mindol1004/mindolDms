...
//                responseData.putField("RESULT", "ERR_IMEI없음");
	 ...
	 * </pre>
	 */
	public IDataSet fSInqFPAEqpSellAvgSendList(IDataSet requestData, IOnlineContext onlineCtx) {
        IDataSet responseData = new DataSet();
    
        try {
            DEPFPAEqpMgmt dEPFPAEqpMgmt = (DEPFPAEqpMgmt) lookupDataUnit(DEPFPAEqpMgmt.class);
            //판매데이터조회
            responseData = dEPFPAEqpMgmt.dSInqFPAEqpSellAvgSendList(requestData, onlineCtx);
