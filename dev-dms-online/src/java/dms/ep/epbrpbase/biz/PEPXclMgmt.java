 ...
 * <li>단위업무명: [PU]미정산내역관리</li>
 * <li>설  명 : <pre>미정산내역관리</pre></li>
 * <li>작성일 : 2015-12-02 17:59:17</li>
 * <li>작성자 : 박민정 (dangnagu2)</li>
 * </ul>
 *
 * @author 박민정 (dangnagu2)
 */
public class PEPXclMgmt extends fwk.base.ProcessUnit {
	 ...
	 * </pre>
	 */
	public IDataSet pInqXclList(IDataSet requestData, IOnlineContext onlineCtx) {
        IDataSet responseData = new DataSet();
        
        try {
            // 1. FM 호출
            responseData = callSharedBizComponentByDirect("ep.EPSRPBase", "fInqXclList", requestData, onlineCtx);
