 ...
 * <li>단위업무명: [PU]단말기매입매출전표현황관리</li>
 * <li>설  명 : <pre>단말기매입매출전표현황관리</pre></li>
 * <li>작성일 : 2015-12-09 11:02:41</li>
 * <li>작성자 : 박민정 (dangnagu2)</li>
 * </ul>
 *
 * @author 박민정 (dangnagu2)
 */
public class PEPEqpPrSNoMgmt extends fwk.base.ProcessUnit {
	 ...
	 * </pre>
	 */
	public IDataSet pInqEqpPrSNoList(IDataSet requestData, IOnlineContext onlineCtx) {
        IDataSet responseData = new DataSet();
        
        try {
            // 1. FM 호출
            responseData = callSharedBizComponentByDirect("ep.EPSRPBase", "fInqEqpPrSNoList", requestData, onlineCtx);
