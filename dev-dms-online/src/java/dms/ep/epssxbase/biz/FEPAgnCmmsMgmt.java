...
//            logger.debug("\n\n\n\n\n\n 마지막일자 : "+requestData.getField("YYYYMM")+DateUtils.getDaysOfMonth(requestData.getField("YYYYMM")));
            params.put("PROC_DT", requestData.getField("YYYYMM")+DateUtils.getDaysOfMonth(requestData.getField("YYYYMM")));
