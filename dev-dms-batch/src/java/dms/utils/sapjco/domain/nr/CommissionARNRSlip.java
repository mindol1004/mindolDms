 ...
 *
 */
public class CommissionARNRSlip implements Serializable{
	...
	private SAP_SLIP_KINDS slipKind = SAP_SLIP_KINDS.FPA_COMMISSION_NR; 
	 ...
	 * @param netAmt
	 */
	public CommissionARNRSlip(SAP_SLIP_KINDS slipKind, String zserial, String lginId, String slipDt, String custCd, String netAmt)
	{
