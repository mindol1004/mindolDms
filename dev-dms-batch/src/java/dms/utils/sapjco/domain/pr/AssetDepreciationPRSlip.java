 ...
 *
 */
public class AssetDepreciationPRSlip implements Serializable{
	...
	private SAP_SLIP_KINDS slipKinds =SAP_SLIP_KINDS.ASSET_DEPRECIATION_PR; 
	...
	public AssetDepreciationPRSlip(String zserial, String userNo, String slipDt, String deptCd, String amt, String refField)
	{
		this.init(zserial, userNo, slipDt, deptCd, amt, refField);
	}
	 ...
	 * @param amt
	 */
	private void init(String zserial, String userNo, String slipDt, String deptCd, String amt,  String refField)
	{
	...
	private void initItem0(CommonSlipItem one)
	{
		...
		one.setDealCoCd(SAP_DEAL_CO_CD.ASSET_DEPRECIATION_AMT_PR.getCode());
