 ...
 * <li>서브 업무명 : XCP001</li>
 * <li>설  명 : <pre>[PR]임대감가상각등록</pre></li>
 * <li>작성일 : 2015-10-06 10:58:10</li>
 * <li>작성자 : 김기열 (k717110)</li>
 * </ul>
 */
public class XCP001 extends AbsBatchComponent {
    private Log log;
    ...
    public void execute(final IBatchContext context) {
       ...
       */  
        ...
        txBegin();   dbStartSession();   dbBeginBatch();    //트랜잭션 시작
     	...
     	dbSelect("SDeprDtlLst", paramMap, makeRecordHandler(context), readSession); //DB 조회
     	dbEndBatch();   dbEndSession(); txCommit();         //트랜잭션 커밋     	

     	//■■ 3.NR_마감감가상각/5.자산테이블 업데이트 ■■
        txBegin();   dbStartSession();   dbBeginBatch();    //트랜잭션 시작
     	log.debug("makeSuperRecordHandler paramMap :"+paramMap);
     	dbSelect("SDeprLst", paramMap, makeSuperRecordHandler(context), readSession); //DB 조회
     	dbEndBatch();   dbEndSession(); txCommit();         //트랜잭션 커밋
