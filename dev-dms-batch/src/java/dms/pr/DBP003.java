...
public class DBP003 extends AbsBatchComponent {
    ...
    public void beforeExecute(IBatchContext context) {    
		...
		if (log.isDebugEnabled()) {
			...
			log.debug("배치 월 :" + context.getInParameter("PROC_DT").substring(0, 6));
			log.debug(resDS);
		}
		*/
    }
    ...
    public AbsRecordHandler makeRecordHandler(IBatchContext context) {
    	AbsRecordHandler rh = new AbsRecordHandler(context) {
			...
			public void handleRecord(IRecord row) {																
				String ifFileNm = "";
				ifFileNm = "P003.SKCC."+context.getInParameter("PROC_DT").substring(0, 6)+"_"+context.getInParameter("FILE_SEQ");				
