 ...
 * <li>서브 업무명 : BIF024</li>
 * <li>설  명 : <pre>[IF]SKN 회수대상 DMS</pre></li>
 * <li>작성일 : 2015-08-11 15:11:56</li>
 * <li>작성자 : 안한모 (ahmlee)</li>
 * </ul>
 */
public class IFR024 extends AbsBatchComponent {
    ...
    public void execute(final IBatchContext context) {
        ...
        try {
            ...
            body.addColumnInfo("RENTAL_BARCD",             11, SAMFileTool.TYPE_STRING);
            body.addColumnInfo("CLCT_ORG_CD",               6, SAMFileTool.TYPE_STRING);
            body.addColumnInfo("CLCT_DT",                   8, SAMFileTool.TYPE_STRING);
            body.addColumnInfo("PROC_ST_CD",                2, SAMFileTool.TYPE_STRING);
            body.initialize();
            
            dbSelect("SSknClctObjDmsLst", queryParam, makeRecordHandler(body), context);  //DB 조회
            ...
            dbUpdate("USknClctObjDms", queryParam, context);	// 처리상태코드 Update
