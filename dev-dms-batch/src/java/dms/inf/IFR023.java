 ...
 * <li>서브 업무명 : BIF023</li>
 * <li>설  명 : <pre>[IF]SKN 회수대상 UKey</pre></li>
 * <li>작성일 : 2015-08-10 11:07:57</li>
 * <li>작성자 : 이영진 (newnofixing)</li>
 * </ul>
 */
public class IFR023 extends AbsBatchComponent {
    ...
    public void execute(final IBatchContext context) {
        ...
        samTool.addColumnInfo("RENTAL_BARCD",             11, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("CLCT_CL",                   1, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("RTN_REG_BR_CD",             6, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("RTN_REG_SUB_BR_CD",         4, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("RTN_REG_DT",                8, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("CLCT_OBJ_REG_DT",           8, SAMFileTool.TYPE_STRING);
    ...
    public AbsRecordHandler makeRecordHandler(IBatchContext context) {
        AbsRecordHandler rh = new AbsRecordHandler(context) {
            ...
            public void handleRecord(IRecord row) {
                ...
                //본업무 처리로직 구현
                dbInsert("ISknClctObjUkey", row, context);
