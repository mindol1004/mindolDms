 ...
 * <li>서브 업무명 : BIF022</li>
 * <li>설  명 : <pre>[IF]렌탈채권이관</pre></li>
 * <li>작성일 : 2015-08-10 11:07:57</li>
 * <li>작성자 : 이영진 (newnofixing)</li>
 * </ul>
 */
public class IFR022 extends AbsBatchComponent {
    ...
    public void execute(final IBatchContext context) {
        ...
        samTool.addColumnInfo("INV_AMT",                   8, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("RECV_AMT",                  8, SAMFileTool.TYPE_STRING);
    ...
    public AbsRecordHandler makeRecordHandler(IBatchContext context) {
        AbsRecordHandler rh = new AbsRecordHandler(context) {
            ...
            public void handleRecord(IRecord row) {
                ...
                //본업무 처리로직 구현
                dbInsert("IRentalBondTrnsf", row, context);
