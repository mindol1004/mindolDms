...
public class IFE007 extends AbsBatchComponent {
    ...
    public void execute(final IBatchContext context) {
        ...
        samTool.addColumnInfo("DPSTR_NM",				50,SAMFileTool.TYPE_STRING);
        ...
        samTool.addColumnInfo("DEALCO_GRP_CD",		    20,SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("DEALCO_GRP_NM",			40,SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("EQP_MDL_NM",             80,SAMFileTool.TYPE_STRING);

        // 암호화 컬럼 정의
        samTool.addColumnInfo("BUYER_NM_ENPT",			 0,SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("DPSTR_NM_ENPT",		     0,SAMFileTool.TYPE_STRING);
    ...
    public AbsRecordHandler makeRecordHandler(IBatchContext context) {
        AbsRecordHandler rh = new AbsRecordHandler(context) {
            ...
            public void handleRecord(IRecord row) {
                ...
                row.set("DPSTR_NM_ENPT", HpcUtils.encodeByAES(row.get("DPSTR_NM")));
                row.set("DPSTR_NM", HpcUtils.maskingName(row.get("DPSTR_NM")));
