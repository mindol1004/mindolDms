 ...
 * <li>서브 업무명 : BIF025</li>
 * <li>설  명 : <pre>[IF]추심위임정보</pre></li>
 * <li>작성일 : 2015-08-10 11:07:57</li>
 * <li>작성자 : 이영진 (newnofixing)</li>
 * </ul>
 */
public class IFR025 extends AbsBatchComponent {
    ...
    public void execute(final IBatchContext context) {
        ...
        samTool.addColumnInfo("COLS_CO_CD",                2, SAMFileTool.TYPE_STRING);
        ...
        samTool.addColumnInfo("COLS_MNDT_DT",              8, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("COLS_MNDT_AMT",            11, SAMFileTool.TYPE_STRING);
    ...
    public AbsRecordHandler makeRecordHandler(IBatchContext context) {
        AbsRecordHandler rh = new AbsRecordHandler(context) {
            ...
            public void handleRecord(IRecord row) {
                ...
                //본업무 처리로직 구현
                dbInsert("IColsMndtInfo", row, context);
