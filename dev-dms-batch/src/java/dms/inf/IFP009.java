 ...
 * <li>서브 업무명 : BIF109</li>
 * <li>설  명 : <pre>[IF]리패키징 승인정보</pre></li>
 * <li>작성일 : 2015-08-10 11:07:57</li>
 * <li>작성자 : 이영진 (newnofixing)</li>
 * </ul>
 */
public class IFP009 extends AbsBatchComponent {
    ...
    public void execute(final IBatchContext context) {
        ...
        samTool.addColumnInfo("APRV_CL_CD",                1, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("APRV_PROC_DT",              8, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("APRV_YN",                   1, SAMFileTool.TYPE_STRING);
    ...
    public AbsRecordHandler makeRecordHandler(IBatchContext context) {
        AbsRecordHandler rh = new AbsRecordHandler(context) {
            ...
            public void handleRecord(IRecord row) {
                ...
                //본업무 처리로직 구현
                dbInsert("IRpkgAprvInfo", row, context);
