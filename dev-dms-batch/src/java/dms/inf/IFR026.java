 ...
 * <li>서브 업무명 : BIF026</li>
 * <li>설  명 : <pre>[IF]렌탈여신한도금액</pre></li>
 * <li>작성일 : 2015-08-10 11:07:57</li>
 * <li>작성자 : 이영진 (newnofixing)</li>
 * </ul>
 */
public class IFR026 extends AbsBatchComponent {
    ...
    public void execute(final IBatchContext context) {
        ...
        samTool.addColumnInfo("SENDRCV_PROC_CL_CD",        1, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("STRD_DT",                   8, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("AFFIL_ORG_ID",              6, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("CRD_LMT_AMT",              13, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("PROC_DT",                   8, SAMFileTool.TYPE_STRING);
    ...
    public AbsRecordHandler makeRecordHandler(IBatchContext context) {
        AbsRecordHandler rh = new AbsRecordHandler(context) {
            ...
            public void handleRecord(IRecord row) {
                ...
                //본업무 처리로직 구현
                dbInsert("IRentalCrdLmtAmt", row, context);
