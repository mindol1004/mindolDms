 ...
 * <li>서브 업무명 : BIF009</li>
 * <li>설  명 : <pre>[IF]보증보험청구결과(승인)</pre></li>
 * <li>작성일 : 2015-08-07 16:40:57</li>
 * <li>작성자 : 이영진 (newnofixing)</li>
 * </ul>
 */
public class IFS005 extends AbsBatchComponent {
    ...
    public void execute(final IBatchContext context) {
        ...
        samTool.addColumnInfo("SVC_MGMT_NO",                11, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("SVC_SCRB_DT",                 8, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("SVC_TERM_DT",                 8, SAMFileTool.TYPE_STRING);
        ...
        samTool.addColumnInfo("INSU_RECV_DT",                8, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("INSU_RECV_AMT",              13, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("ST_CD",                       1, SAMFileTool.TYPE_STRING);
    ...
    public AbsRecordHandler makeRecordHandler(IBatchContext context) {
        AbsRecordHandler rh = new AbsRecordHandler(context) {
            ...
            public void handleRecord(IRecord row) {
                ...
                dbInsert("IInsuInvRsltAprv", row, context);
