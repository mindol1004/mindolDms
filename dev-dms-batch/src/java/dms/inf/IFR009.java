 ...
 * <li>서브 업무명 : BIF009</li>
 * <li>설  명 : <pre>[IF]청구 내역 동기화</pre></li>
 * <li>작성일 : 2015-08-07 16:40:57</li>
 * <li>작성자 : 이영진 (newnofixing)</li>
 * </ul>
 */
public class IFR009 extends AbsBatchComponent {
    ...
    public void execute(final IBatchContext context) {
        ...
        samTool.addColumnInfo("INV_CL_CD",                 3, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("INV_SER_NO",                3, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("INV_AMT",                  15, SAMFileTool.TYPE_STRING);
