 ...
 * <li>서브 업무명 : BSC002</li>
 * <li>설  명 : <pre>[IF]R센터 입고 등록(신규R)</pre></li>
 * <li>작성일 : 2015-08-11 13:25:31</li>
 * <li>작성자 : 이영진 (newnofixing)</li>
 * </ul>
 */
public class IFR007 extends AbsBatchComponent {
    ...
    public void execute(final IBatchContext context) {
        ...
        try {
            ...
            body.addColumnInfo("R_CNTR_IN_DT",              8, SAMFileTool.TYPE_STRING);
            body.addColumnInfo("SVC_MGMT_NO",              10, SAMFileTool.TYPE_STRING);
            body.addColumnInfo("RENTAL_SER_NO",            15, SAMFileTool.TYPE_BIGDECIMAL);
            body.initialize();
            
            dbSelect("SNrRCntrInRegLst", queryParam, makeRecordHandler(body), context);  //DB 조회
            
            //20150911 start
            preTaskSTCD = "S";
            IOnlineContext    onlineCtx  = makeOnlineContext(context);
            IDataSet reqDS = new DataSet();
            reqDS.putField("TASK_ID", "DBR007");
            reqDS.putField("TASK_DT", DateUtils.getCurrentDate());
            if (processCnt == 0) {
            ...
            dbUpdate("UNrRCntrInReg", queryParam, context);	// 처리상태코드 Update
