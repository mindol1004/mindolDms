 ...
 * </ul>
 */
public class DBS003 extends AbsBatchComponent {
    ...
    public void execute(final IBatchContext context) {
        ...
        dbSelect("SInsuInvDtl", paramMap, makeRecordHandler(context), context); //단말기렌탈정책조회
    ...
    public AbsRecordHandler makeRecordHandler(IBatchContext context) {
        ...
        AbsRecordHandler rh = new AbsRecordHandler(context) {
            ...
            public void handleRecord(IRecord row) {
                ...
                reqDs.putField("IF_FILE_NM", "S003.SKCC." + context.getInParameter("PROC_DT").substring(0,6) + "_" + context.getInParameter("FILE_SEQ"));
                reqDs.putField("PROC_ST_CD", "09");
                
                dbInsert("IIFInsuInvListDtl", reqDs.getFieldMap(), context);
