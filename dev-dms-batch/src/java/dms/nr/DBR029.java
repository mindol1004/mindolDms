 ...
 * </ul>
 */
public class DBR029 extends AbsBatchComponent {
    private Log log;
    ...
    public void execute(final IBatchContext context) {
        ...
        dbSelect("SIFInsuInvObjDtl", paramMap, makeRecordHandler(context), context); //DB 조회        

        dbUpdate("UIFInsuInvObjDtl", paramMap, context);   //인터페이스테이블 처리상태 변경
    ...
    public AbsRecordHandler makeRecordHandler(IBatchContext context) {
        AbsRecordHandler rh = new AbsRecordHandler(context) {
            ...
            public void handleRecord(IRecord row) {
                ...
                dbInsert("IInsuInvDtl", reqDs.getFieldMap(), context);
