 ...
 * </ul>
 */
public class DBR018 extends AbsBatchComponent {
    private Log log;
    ...
    public void execute(final IBatchContext context) {
        ...
        dbSelect("SIFInsuInvObj", paramMap, makeRecordHandler(context), context); //DB 조회        

        dbUpdate("UIFInsuInvObj", paramMap, context);   //인터페이스테이블 처리상태 변경
    ...
    public AbsRecordHandler makeRecordHandler(IBatchContext context) {
        AbsRecordHandler rh = new AbsRecordHandler(context) {
            ...
            public void handleRecord(IRecord row) {
                ...
                String INSU_INV_NO = (String) dbInsertAndReturnPK("IInsuInv", reqDs.getFieldMap(), context);
                reqDs.putField("INSU_INV_NO", INSU_INV_NO);
    ...
    public void afterExecute(IBatchContext context) {
        ...
        log = getLog(context);
        if(log.isDebugEnabled()) {
            log.debug("보증보험청구대상 BATCH 호출 결과:");
            log.debug(resDS);
        }
        */
    }
