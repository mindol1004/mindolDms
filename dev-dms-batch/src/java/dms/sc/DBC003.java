 ...
 * <li>설  명 : <pre>[SC]R서비스중도해지계약종료SMS안내</pre></li>
 * <li>작성일 : 2015-08-04</li>
 * <li>작성자 : 이영진 (newnofixing)</li>
 * </ul>
 */
public class DBC003 extends AbsBatchComponent {
	...
	public void execute(final IBatchContext context) {
    	...
    	dbInsert("INRSmsInfo",null);
    	dbSelect("SCntrtEndNEW", null, makeRecordHandler(context), context); //중도해지 계약종료목록
    	dbUpdate("UNRSmsInfo",null);
