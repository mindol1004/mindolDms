 ...
 *
 */
public class InsfeeARNRSlip implements Serializable{
	...
	private SAP_SLIP_KINDS slipKind = SAP_SLIP_KINDS.INS_COMMISSION_AR_NR; 
	 ...
	 * @param netAmt
	 */
	public InsfeeARNRSlip(SAP_SLIP_KINDS slipKind, String zserial, String lginId, String slipDt, String custCd, String netAmt)
	{
	...
	private void initCr(CommonSlipItem one, CommonSlipHeader header)
	{
		...
		one.setDealCoCd(SAP_DEAL_CO_CD.UNEXPOSED_INSURANCE.getCode());
	}
