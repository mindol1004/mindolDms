 ...
 * <li>서브 업무명 : BIF006</li>
 * <li>설  명 : <pre>[IF]보증보험가입해지(SGI)</pre></li>
 * <li>작성일 : 2015-08-07 16:40:57</li>
 * <li>작성자 : 이영진 (newnofixing)</li>
 * </ul>
 */
public class IFS001 extends AbsBatchComponent {
    ...
    public void execute(final IBatchContext context) {
        ...
        samTool.addColumnInfo("OP_CL_CD",          2, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("CUST_TYP_CD",       2, SAMFileTool.TYPE_STRING);
        ...
        samTool.addColumnInfo("INSU_FEE",         10, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("CBACK_INSU_FEE",   10, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("RUSER_EXTT_YN",     1, SAMFileTool.TYPE_STRING);
    ...
    public AbsRecordHandler makeRecordHandler(IBatchContext context) {
        AbsRecordHandler rh = new AbsRecordHandler(context) {
            ...
            public void handleRecord(IRecord row) {
                ...
                dbInsert("IInsuScrbTerm", row, context);
