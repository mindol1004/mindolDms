...
public class SalesCommissionSlip implements Serializable{
	...
	private SAP_SLIP_KINDS slipKind = SAP_SLIP_KINDS.SALES_COMMISSION; 
	 ...
	 * @param netAmt
	 */
	public SalesCommissionSlip(SAP_SLIP_KINDS slipKind, String zserial, String lginId, String slipDt, String custCd, String netAmt)
	{
