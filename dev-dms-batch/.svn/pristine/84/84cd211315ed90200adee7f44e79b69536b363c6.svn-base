 ...
 * <li>서브 업무명 : BIF015</li>
 * <li>설  명 : <pre>[IF]정산 요청</pre></li>
 * <li>작성일 : 2015-08-10 11:07:57</li>
 * <li>작성자 : 이영진 (newnofixing)</li>
 * </ul>
 */
public class IFR015 extends AbsBatchComponent {
    ...
    public void execute(final IBatchContext context) {
        ...
        samTool.addColumnInfo("XCL_PROC_DT",               8, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("XCL_CL_CD",                 5, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("PROC_STA_DT",               8, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("PROC_END_DT",               8, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("EXTSTTL_ST_CD",             1, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("PAY_CO_CL_CD",              1, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("SPDM_CO_CL_CD",             1, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("SKT_OBJ_CNT",              11, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("SKT_OBJ_AMT",              15, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("SKT_CALC_XCL_AMT",         15, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("SKT_ADJ_AMT",              15, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("SKT_CONF_XCL_AMT",         15, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("SKCC_OBJ_CNT",             11, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("SKCC_OBJ_AMT",             15, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("SKCC_CALC_XCL_AMT",        15, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("SKCC_ADJ_AMT",             15, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("SKCC_CONF_XCL_AMT",        15, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("SKT_XCL_APRV_DTM",         14, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("SKT_XCL_APRV_ID",          15, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("SKCC_XCL_APRV_DTM",        14, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("SKCC_XCL_APRV_ID",         15, SAMFileTool.TYPE_STRING);
