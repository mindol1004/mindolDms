 ...
 * <li>서브 업무명 : BIF019</li>
 * <li>설  명 : <pre>[IF]보증보험청구결과</pre></li>
 * <li>작성일 : 2015-08-11 15:01:17</li>
 * <li>작성자 : 안한모 (ahmlee)</li>
 * </ul>
 */
public class IFR019 extends AbsBatchComponent {
    ...
    public void execute(final IBatchContext context) {
        ...
        try {
            ...
            body.addColumnInfo("BLICENS_NO",               10, SAMFileTool.TYPE_STRING);
            body.addColumnInfo("INSU_MGMT_NO",             14, SAMFileTool.TYPE_STRING);
            body.addColumnInfo("SVC_MGMT_NO",              10, SAMFileTool.TYPE_STRING);
            body.addColumnInfo("RENTAL_SER_NO",            15, SAMFileTool.TYPE_STRING);
            body.addColumnInfo("INSU_INV_DT",               8, SAMFileTool.TYPE_STRING);
            body.addColumnInfo("INSU_INV_AMT",             13, SAMFileTool.TYPE_STRING);
            body.addColumnInfo("INSU_INV_PROC_CD",          2, SAMFileTool.TYPE_STRING);
            body.addColumnInfo("INSU_INV_PROC_DTL_CD",      2, SAMFileTool.TYPE_STRING);
            body.addColumnInfo("INSU_INV_DMISL_STEP_CD",    2, SAMFileTool.TYPE_STRING);
            body.addColumnInfo("INSUCO_ERR_CD",             2, SAMFileTool.TYPE_STRING);
            body.addColumnInfo("NEWLINE",                   1, SAMFileTool.TYPE_STRING);
            body.initialize();
            
            dbSelect("SInsuInvRsltLst", queryParam, makeRecordHandler(body), context);  //DB 조회
            
            //20150911 start
            preTaskSTCD = "S";
            IOnlineContext    onlineCtx  = makeOnlineContext(context);
            IDataSet reqDS = new DataSet();
            reqDS.putField("TASK_ID", "DBR019");
            reqDS.putField("TASK_DT", DateUtils.getCurrentDate());
            if (processCnt == 0) {
            ...
            dbUpdate("UInsuInvRslt", queryParam, context);	// 처리상태코드 Update
