...
/**
 * 미납채권 제각 2 
 * 거래처, 대손상각비, 대손충당금-외상매출액 
 * @author greatjin
 *
 */
public class BondDisposal2NRSlip implements Serializable{
	...
	private SAP_SLIP_KINDS slipKind       = SAP_SLIP_KINDS.BOND_DISPOSAL2_NR; 
    private SAP_SLIP_KINDS cancelSlipKind = SAP_SLIP_KINDS.BOND_DISPOSAL2_NR;
	...
	public BondDisposal2NRSlip(String zserial, String userNo, String slipDt, String custCd, String amt, String afbdAmt, String bdeAmt, String txt)
	{
		this.init(zserial, userNo, slipDt, custCd, amt, afbdAmt, bdeAmt, txt, false);
	}
	
    public BondDisposal2NRSlip(String zserial, String userNo, String slipDt, String custCd, String amt, String afbdAmt, String bdeAmt, String txt, boolean cancelFlag)
    {
        this.init(zserial, userNo, slipDt, custCd, amt, afbdAmt, bdeAmt, txt,true);
    }
	 ...
	 * @param amt
	 */
	private void init(String zserial, String userNo, String slipDt, String custCd, String amt, String afbdAmt, String bdeAmt, String txt, boolean cancelSlipFlag)
	{
		...
		initItem0(items[0]);
		initItem1(items[1]); //대손충당금-외상매출금
		items[1].setAmt(afbdAmt);
		initItem2(items[2]); //대손상각비
		items[2].setAmt(bdeAmt);
	}
    ...
    private void initItem2(CommonSlipItem one)
    {
       if(cancelSlipFlag)
        ...
        one.setDealCoCd(SAP_DEAL_CO_CD.BDE.getCode());
