 ...
 * <li>서브 업무명 : BIF006</li>
 * <li>설  명 : <pre>[IF]단말기별회수일자</pre></li>
 * <li>작성일 : 2015-08-07 16:40:57</li>
 * <li>작성자 : 이영진 (newnofixing)</li>
 * </ul>
 */
public class IFE005 extends AbsBatchComponent {
    ...
    public void execute(final IBatchContext context) {
        ...
        samTool.addColumnInfo("UNUSE_CTZ_REG_NO",		30,SAMFileTool.TYPE_STRING);		/* 테이블 컬럼은 삭제 */
        ...
        samTool.addColumnInfo("CLCT_DT",			 	 8,SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("FILLER",					 6,SAMFileTool.TYPE_STRING);
    ...
    public AbsRecordHandler makeRecordHandler(IBatchContext context) {
        AbsRecordHandler rh = new AbsRecordHandler(context) {
            ...
            public void handleRecord(IRecord row) {
                ...
                dbInsert("IByeqpClctDt", row, context);
