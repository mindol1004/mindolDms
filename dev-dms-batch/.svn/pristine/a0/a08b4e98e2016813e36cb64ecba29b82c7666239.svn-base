 ...
 * <li>서브 업무명 : BIF108</li>
 * <li>설  명 : <pre>[IF]리패키징/불용/계약만료정보 등록</pre></li>
 * <li>작성일 : 2015-08-11 16:07:14</li>
 * <li>작성자 : 안한모 (ahmlee)</li>
 * </ul>
 */
public class IFP008 extends AbsBatchComponent {
    ...
    public void execute(final IBatchContext context) {
        ...
        try {
            ...
            body.addColumnInfo("INFO_PROC_CL_CD",           1, SAMFileTool.TYPE_STRING);
            body.addColumnInfo("RECMC_INFO" ,             410, SAMFileTool.TYPE_STRING);
            body.initialize();
            
            dbSelect("SRpkgCnctExpirInfoLst", queryParam, makeRecordHandler(body), context);  //DB 조회
            
            //20150911 start
            preTaskSTCD = "S";
            IOnlineContext    onlineCtx  = makeOnlineContext(context);
            IDataSet reqDS = new DataSet();
            reqDS.putField("TASK_ID", "DBP008");
            reqDS.putField("TASK_DT", DateUtils.getCurrentDate());
            if (processCnt == 0) {
            ...
            dbUpdate("URpkgCnctExpirInfo", queryParam, context);	// 처리상태코드 Update
