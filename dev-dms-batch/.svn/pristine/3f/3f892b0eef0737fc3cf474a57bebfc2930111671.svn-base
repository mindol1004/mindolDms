 ...
 * <li>서브 업무명 : BIF001</li>
 * <li>설  명 : <pre>[IF]단말기정보</pre></li>
 * <li>작성일 : 2015-07-29 10:17:57</li>
 * <li>작성자 : 이영진 (newnofixing)</li>
 * </ul>
 */
public class IFR001 extends AbsBatchComponent {
    ...
    public void execute(final IBatchContext context) {
        ...
        samTool.addColumnInfo("MFACT_CD",        2, SAMFileTool.TYPE_STRING);
