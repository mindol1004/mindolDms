 ...
 *
 */
public class AssetDisposalPRSlip implements Serializable{
	...
	private SAP_SLIP_KINDS slipKinds =SAP_SLIP_KINDS.ASSET_DISPOSAL_PR; 
	...
	public AssetDisposalPRSlip(String zserial, String userNo, String slipDt, String deptCd, String amt, String prcAmt, String ldtaAmt)
	{
