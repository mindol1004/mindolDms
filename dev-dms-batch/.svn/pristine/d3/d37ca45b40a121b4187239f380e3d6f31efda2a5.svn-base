 ...
 *
 */
public class CommissionNRSlip implements Serializable{
	 ...
	 * @param netAmt
	 */
	public CommissionNRSlip(SAP_SLIP_KINDS slipKind, String zserial, String lginId, String slipDt, String custCd, String netAmt)
	{
