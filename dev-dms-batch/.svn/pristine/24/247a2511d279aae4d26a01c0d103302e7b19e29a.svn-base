 ...
 * <li>서브 업무명 : BIF110</li>
 * <li>설  명 : <pre>[IF]색상생산업체코드</pre></li>
 * <li>작성일 : 2015-08-10 11:07:57</li>
 * <li>작성자 : 이영진 (newnofixing)</li>
 * </ul>
 */
public class IFP010 extends AbsBatchComponent {
    ...
    public void execute(final IBatchContext context) {
        ...
        samTool.addColumnInfo("CD_CL",                     2, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("CM_CD",                    30, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("CM_CD_NM",                 80, SAMFileTool.TYPE_STRING);
    ...
    public AbsRecordHandler makeRecordHandler(IBatchContext context) {
        AbsRecordHandler rh = new AbsRecordHandler(context) {
            ...
            public void handleRecord(IRecord row) {
                ...
                //본업무 처리로직 구현
                dbInsert("IColorMfactCd", row, context);
