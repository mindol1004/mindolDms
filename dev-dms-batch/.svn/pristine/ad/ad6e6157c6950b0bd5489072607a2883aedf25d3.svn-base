 ...
 * <li>서브 업무명 : BIF005</li>
 * <li>설  명 : <pre>[IF]SKN 여신정보</pre></li>
 * <li>작성일 : 2015-08-10 11:07:57</li>
 * <li>작성자 : 이영진 (newnofixing)</li>
 * </ul>
 */
public class IFT001 extends AbsBatchComponent {
    ...
    public void execute(final IBatchContext context) {
        ...
        samTool.addColumnInfo("XCL_YM",                    6, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("TS",                        2, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("SKN_AGN_CD",                6, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("USE_AMT",                  15, SAMFileTool.TYPE_BIGDECIMAL);
    ...
    public AbsRecordHandler makeRecordHandler(IBatchContext context) {
        AbsRecordHandler rh = new AbsRecordHandler(context) {
            ...
            public void handleRecord(IRecord row) {
                ...
                //본업무 처리로직 구현
                dbInsert("ISknCrdInfo", row, context);
