 ...
 * <li>서브 업무명 : DBR020</li>
 * <li>설  명 : </li>
 * <li>작성일 : 2016-02-15 16:47:08</li>
 * <li>작성자 : 안진갑 (bella21cjk)</li>
 * </ul>
 */
public class DBR020 extends AbsBatchComponent {
    private Log log;
    ...
    public void execute(final IBatchContext context) {
    	...
    	dbSelect("SInsuRecvItm", paramMap, makeRecordHandler(context), context); //해지요청
    ...
    public AbsRecordHandler makeRecordHandler(IBatchContext context) {
    	...
    	AbsRecordHandler rh = new AbsRecordHandler(context) {
    		...
    		int ifSeq = 1;
    		String ifFileNm = "R020.SKCC."+context.getInParameter("PROC_DT")+"_"+context.getInParameter("FILE_SEQ");	
    		IDataSet reqDs = new DataSet();
			...
			public void handleRecord(IRecord row) {
				...
				dbInsert("IInsuRecvItm", reqDs.getFieldMap(), context);
