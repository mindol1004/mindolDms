 ...
 * <li>서브 업무명 : BIF103</li>
 * <li>설  명 : <pre>[IF]단말기 잔존가치</pre></li>
 * <li>작성일 : 2015-08-11 15:43:59</li>
 * <li>작성자 : 안한모 (ahmlee)</li>
 * </ul>
 */
public class IFP003 extends AbsBatchComponent {
    ...
    public void execute(final IBatchContext context) {
        ...
        try {
            ...
            body.addColumnInfo("REM_VALUE_STRD_YM",         6, SAMFileTool.TYPE_STRING);
            body.addColumnInfo("EQP_MDL_CD",                5, SAMFileTool.TYPE_STRING);
            body.addColumnInfo("EQP_SER_NO",               15, SAMFileTool.TYPE_STRING);
            body.addColumnInfo("EQP_REM_AMT",              11, SAMFileTool.TYPE_STRING);
            body.initialize();
            
            dbSelect("SEqpRemValueLst", queryParam, makeRecordHandler(body), context);  //DB 조회
            
            //20150911 start
            preTaskSTCD = "S";
            IOnlineContext    onlineCtx  = makeOnlineContext(context);
            IDataSet reqDS = new DataSet();
            reqDS.putField("TASK_ID", "DBP003");
            reqDS.putField("TASK_DT", DateUtils.getCurrentDate());
            if (processCnt == 0) {
            ...
            dbUpdate("UEqpRemValue", queryParam, context);	// 처리상태코드 Update
