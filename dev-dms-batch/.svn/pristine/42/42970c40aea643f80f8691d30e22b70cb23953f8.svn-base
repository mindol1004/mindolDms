 ...
 * </ul>
 */
public class DBR003 extends AbsBatchComponent {
    ...
    public void execute(final IBatchContext context) {
        ...
        paramMap.put("IF_PROC_DT", context.getInParameter("PROC_DT"));    //처리일
    	
    	dbSelect("SEqpRentalPoly", paramMap, makeRecordHandler(context), context); //단말기렌탈정책조회
    ...
    public AbsRecordHandler makeRecordHandler(IBatchContext context) {
    	...
    	AbsRecordHandler rh = new AbsRecordHandler(context) {
			...
			public void handleRecord(IRecord row) {
				...
				reqDs.putField("IF_FILE_NM", "R003.SKCC." + context.getInParameter("PROC_DT") + "_" + context.getInParameter("FILE_SEQ"));
