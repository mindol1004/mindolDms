 ...
 * <li>서브 업무명 : BIF107</li>
 * <li>설  명 : <pre>[IF]단말기 평가 정보 등록(임대R)</pre></li>
 * <li>작성일 : 2015-08-11 16:03:10</li>
 * <li>작성자 : 안한모 (ahmlee)</li>
 * </ul>
 */
public class IFP007 extends AbsBatchComponent {
    ...
    public void execute(final IBatchContext context) {
        ...
        try {
            ...
            body.addColumnInfo("CMPT_INDF_BACK_AMT",       11, SAMFileTool.TYPE_BIGDECIMAL);
            body.addColumnInfo("EQP_BKAG_INDF_AMT",        11, SAMFileTool.TYPE_BIGDECIMAL);
            body.addColumnInfo("EQP_BKAG_RSN",             30, SAMFileTool.TYPE_STRING);
            body.addColumnInfo("CMPT_INFO",                60, SAMFileTool.TYPE_STRING);
            body.initialize();
            
            dbSelect("SPrEqpEvalInfoRegLst", queryParam, makeRecordHandler(body), context);  //DB 조회
            
            //20150911 start
            preTaskSTCD = "S";
            IOnlineContext    onlineCtx  = makeOnlineContext(context);
            IDataSet reqDS = new DataSet();
            reqDS.putField("TASK_ID", "DBP007");
            reqDS.putField("TASK_DT", DateUtils.getCurrentDate());
            if (processCnt == 0) {
            ...
            dbUpdate("UPrEqpEvalInfoReg", queryParam, context);	// 처리상태코드 Update
