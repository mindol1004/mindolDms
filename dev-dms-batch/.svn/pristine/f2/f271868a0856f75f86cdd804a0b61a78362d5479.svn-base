 ...
 * <li>설  명 : <pre>[SC]R서비스계약종료SMS안내</pre></li>
 * <li>작성일 : 2015-08-04</li>
 * <li>작성자 : 이영진 (newnofixing)</li>
 * </ul>
 */
public class DBC001 extends AbsBatchComponent {
	...
	public void execute(final IBatchContext context) {
    	...
    	dbSelect("SCntrtEnd", null, makeRecordHandler(context), context); //계약종료목록
    ...
    public AbsRecordHandler makeRecordHandler(IBatchContext context) {
        AbsRecordHandler rh = new AbsRecordHandler(context) {
			...
			public void handleRecord(IRecord row) {
	            ...
	            String msgCl = row.get("ALRT_MSG_CL");
	            
	            String[] sSvcList;
	            
	            if ("DM31".equals(msgCl) || "DM7".equals(msgCl)) {
	                sSvcList = new String[]{month+"월"+day+"일", "렌탈"};
	            } else if ("D".equals(msgCl)) {
                    sSvcList = new String[]{"렌탈", month+"월"+day+"일"};
                } else if ("DP14".equals(msgCl) || "DP21".equals(msgCl)) {
                    sSvcList = new String[]{month+"월"+day+"일"};
                } else {
                    sSvcList = null;
                }
