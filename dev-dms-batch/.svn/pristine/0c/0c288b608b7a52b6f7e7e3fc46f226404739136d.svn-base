 ...
 * <li>서브 업무명 : BSC002</li>
 * <li>설  명 : <pre>[IF]단말 구성품 등록(신규R)</pre></li>
 * <li>작성일 : 2015-08-11 13:25:31</li>
 * <li>작성자 : 이영진 (newnofixing)</li>
 * </ul>
 */
public class IFR004 extends AbsBatchComponent {
    ...
    public void execute(final IBatchContext context) {
        ...
        try {
            ...
            dbSelect("SNrEqpCmptRegLst", queryParam, makeRecordHandler(body), context);  //DB 조회
            
            //20150911 start
            preTaskSTCD = "S";
            IOnlineContext    onlineCtx  = makeOnlineContext(context);
            IDataSet reqDS = new DataSet();
            reqDS.putField("TASK_ID", "DBR004");
            reqDS.putField("TASK_DT", DateUtils.getCurrentDate());
            if (processCnt == 0) {
            ...
            dbUpdate("UNrEqpCmptReg", queryParam, context);	// 처리상태코드 Update
