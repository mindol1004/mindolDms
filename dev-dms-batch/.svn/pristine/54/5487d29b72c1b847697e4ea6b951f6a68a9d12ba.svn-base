 ...
 * <li>서브 업무명 : BIF009</li>
 * <li>설  명 : <pre>[IF]보증보험기각내역</pre></li>
 * <li>작성일 : 2015-08-07 16:40:57</li>
 * <li>작성자 : 이영진 (newnofixing)</li>
 * </ul>
 */
public class IFS004 extends AbsBatchComponent {
    ...
    public void execute(final IBatchContext context) {
        ...
        samTool.addColumnInfo("CO_CL_CD",                       3, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("INSURE_CL_CD",                   2, SAMFileTool.TYPE_STRING);
        ...
        samTool.addColumnInfo("USE_SUSP_DT",                    8, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("ATHO_TERM_DT",                   8, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("INSU_INV_DT",                    8, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("INSU_INV_AMT",                  13, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("NMZT_RSN_CD",                    2, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("ERR_CL_CD",                      2, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("ERR_DTL_CD",                    10, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("CUST_NM",                       40, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("MOGAHA_NM",                     40, SAMFileTool.TYPE_STRING);
        samTool.addColumnInfo("BOND_NO",                        9, SAMFileTool.TYPE_STRING);
    ...
    public AbsRecordHandler makeRecordHandler(IBatchContext context) {
        AbsRecordHandler rh = new AbsRecordHandler(context) {
            ...
            public void handleRecord(IRecord row) {
                ...
                dbInsert("IInsuDmislList", row, context);
