 ...
 *
 */
public class RentalPRSlip implements Serializable{
	...
	private SAP_SLIP_KINDS slipKinds =SAP_SLIP_KINDS.RENTAL_PR; 
	...
	public RentalPRSlip(SAP_SLIP_KINDS slipKind,String zserial, String userNo, String slipDt, String custCd, String amt, String refTxt)
	{
		this.init(slipKind,zserial, userNo, slipDt, custCd, amt, refTxt);
	}
	 ...
	 * @param amt
	 */
	private void init(SAP_SLIP_KINDS slipKind, String zserial, String userNo , String slipDt, String custCd, String amt, String refTxt)
	{
		
		this.slipKinds =slipKind; 
	...
	private void initCr(CommonSlipItem one)
	{
		...
		one.setDealCoCd(SAP_DEAL_CO_CD.LEASE_INCOME_PR.getCode());
