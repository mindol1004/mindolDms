 ...
 * <li>서브 업무명 : BIF006</li>
 * <li>설  명 : <pre>[IF]SKN 입고 등록</pre></li>
 * <li>작성일 : 2015-08-07 16:40:57</li>
 * <li>작성자 : 이영진 (newnofixing)</li>
 * </ul>
 */
public class IFR006 extends AbsBatchComponent {
    ...
    public void execute(final IBatchContext context) {
        ...
        samTool.addColumnInfo("RTN_REG_BR_CD",    10, SAMFileTool.TYPE_STRING);
        ...
        samTool.addColumnInfo("SKN_CLCT_DT",       8, SAMFileTool.TYPE_STRING);
