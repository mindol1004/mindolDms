 ...
 * <li>서브 업무명 : BSC002</li>
 * <li>설  명 : <pre>[IF]렌탈정책등록</pre></li>
 * <li>작성일 : 2015-07-30 15:18:31</li>
 * <li>작성자 : 이영진 (newnofixing)</li>
 * </ul>
 */
public class IFR003 extends AbsBatchComponent {
    ...
    public void execute(final IBatchContext context) {
        ...
        try {
            ...
            body.addColumnInfo("PROC_CL_CD",             2, SAMFileTool.TYPE_STRING);
            body.addColumnInfo("RENTAL_PLAN_ID",        15, SAMFileTool.TYPE_STRING);
            body.addColumnInfo("RENTAL_CNTRT_MTH_CNT",   2, SAMFileTool.TYPE_BIGDECIMAL);
            body.addColumnInfo("POLY_STA_DT",            8, SAMFileTool.TYPE_STRING);
            body.addColumnInfo("POLY_END_DT",            8, SAMFileTool.TYPE_STRING);
            body.addColumnInfo("FST_STRD_AMT",          11, SAMFileTool.TYPE_BIGDECIMAL);
            body.addColumnInfo("MM_RENTAL_FEE",         11, SAMFileTool.TYPE_BIGDECIMAL);
            body.addColumnInfo("GROSS_RENTAL_FEE",      11, SAMFileTool.TYPE_BIGDECIMAL);
            body.addColumnInfo("EQP_MDL_CD",             5, SAMFileTool.TYPE_STRING);
            body.initialize();
            
            dbSelect("SRentalPolyLst", queryParam, makeRecordHandler(body), context);  //DB 조회
            
            //20150911 start
            preTaskSTCD = "S";
            IOnlineContext    onlineCtx  = makeOnlineContext(context);
            IDataSet reqDS = new DataSet();
            reqDS.putField("TASK_ID", "DBR003");
            reqDS.putField("TASK_DT", DateUtils.getCurrentDate());
            if (processCnt == 0) {
            ...
            dbUpdate("URentalPoly", queryParam, context);	// 처리상태코드 Update
