 ...
 *
 */
public class PanaltyFeeSlip implements Serializable{
	...
	private SAP_SLIP_KINDS slipKinds =SAP_SLIP_KINDS.PANALTY_FEE; 
	...
	public PanaltyFeeSlip(String zserial, String userNo, String slipDt, String custCd, String amt, String refTxt)
	{
