 ...
 * <li>서브 업무명 : BIF101</li>
 * <li>설  명 : <pre>[IF]단말기등록</pre></li>
 * <li>작성일 : 2015-08-11 15:31:37</li>
 * <li>작성자 : 안한모 (ahmlee)</li>
 * </ul>
 */
public class IFP001 extends AbsBatchComponent {
    ...
    public void execute(final IBatchContext context) {
        ...
        try {
            ...
            body.addColumnInfo("EQP_ACQR_AMT",             11, SAMFileTool.TYPE_STRING);
            body.addColumnInfo("EQP_REG_CL",                1, SAMFileTool.TYPE_STRING);
            body.addColumnInfo("EXPART_OBJ_EQP_MDL_CD",     5, SAMFileTool.TYPE_STRING);
            body.addColumnInfo("EXPART_OBJ_EQP_SER_NO",    15, SAMFileTool.TYPE_STRING);
            body.addColumnInfo("PROC_ST_CD",                2, SAMFileTool.TYPE_STRING);
            body.initialize();
            
            dbSelect("SEqpRegLst", queryParam, makeRecordHandler(body), context);  //DB 조회
            ...
            dbUpdate("UEqpReg", queryParam, context);	// 처리상태코드 Update
