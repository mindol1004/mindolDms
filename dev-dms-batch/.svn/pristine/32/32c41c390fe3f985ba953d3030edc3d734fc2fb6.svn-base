 ...
 *
 */
public class CancelChargeSlip implements Serializable{
	...
	private SAP_SLIP_KINDS slipKinds =SAP_SLIP_KINDS.CANCEL_CHARGE; 
	...
	public CancelChargeSlip(String zserial, String userNo, String slipDt, String custCd, String amt, String refTxt)
	{
