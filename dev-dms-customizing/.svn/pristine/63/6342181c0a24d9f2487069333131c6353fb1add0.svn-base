 ...
 *
 */
public class ReturnCommissionSlip implements Serializable{
	...
	public ReturnCommissionSlip(String zserial, String lginId, String slipDt, String custCd, String netAmt)
	{
