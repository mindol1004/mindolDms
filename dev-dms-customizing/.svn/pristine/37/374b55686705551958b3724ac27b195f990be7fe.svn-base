...
WL_HOME="/app/weblogic/Middleware/wlserver_10.3"
export WL_HOME
...
DOMAIN_HOME="/app/weblogic/domains/HPCDEV_Domain"
export DOMAIN_HOME

LONG_DOMAIN_HOME="/app/weblogic/domains/HPCDEV_Domain"
...
#EAI Environment Setting start
#This setting is required by EAI and SPC Customers. SK C&C AA and FWK Technician did oppose this structure.
#We are never responsible for the problems caused by EAI Setting. 2014.07.14 By SK C&C

API_HOME="/app/mqm/EAI/API"
CLASSPATH="${CLASSPATH}${API_HOME}/java/lib/wmqapi.jar"
CLASSPATH="${CLASSPATH}:${API_HOME}/java/lib/MQInterfaceSDK.1.0.3.jar:${API_HOME}/java/lib/backport-util-concurrent.jar"
CLASSPATH="${CLASSPATH}:${API_HOME}/java/lib/com.ibm.mq.commonservices.jar:${API_HOME}/java/lib/com.ibm.mq.headers.jar"
CLASSPATH="${CLASSPATH}:${API_HOME}/java/lib/com.ibm.mq.jar:${API_HOME}/java/lib/com.ibm.mq.jmqi.jar"
CLASSPATH="${CLASSPATH}:${API_HOME}/java/lib/connector.jar:${API_HOME}/java/lib/datedFileAppender-1.0.2.jar:"
CLASSPATH="${CLASSPATH}:${API_HOME}/java/lib/jdom.jar:${API_HOME}/java/lib/log4j-1.2.15.jar"
JAVA_OPTIONS="${JAVA_OPTIONS} -Deai.api.java.home=${API_HOME}"
#EAI Environment Setting End
